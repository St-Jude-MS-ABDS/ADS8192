...
3.  Visualize elements of a `SummarizedExperiment` (assays, rowData,
    colData) with a Bioconductor visualization package
4.  Extract assay data from a `SummarizedExperiment` and use it to run
    PCA
5.  Write small, testable functions that take structured objects as
    input and return well-defined outputs
...
|--------------------------------------------------------------------------------------------------------------------|-------------------------|--------------------------|----------------------|
| [`make_se()`](https://automatic-engine-4qp7m5e.pages.github.io/reference/make_se.md)                               | Create SE from raw data | counts matrix + metadata | SummarizedExperiment |
| [`top_variable_features()`](https://automatic-engine-4qp7m5e.pages.github.io/reference/top_variable_features.md)   | Select variable genes   | SE + n                   | Subsetted SE         |
| [`run_pca()`](https://automatic-engine-4qp7m5e.pages.github.io/reference/run_pca.md)                               | Perform PCA             | SE + parameters          | list(pca, scores)    |
| [`pca_variance_explained()`](https://automatic-engine-4qp7m5e.pages.github.io/reference/pca_variance_explained.md) | Get variance stats      | PCA result               | data.frame           |
| [`plot_pca()`](https://automatic-engine-4qp7m5e.pages.github.io/reference/plot_pca.md)                             | Visualize PCA           | PCA result + aesthetics  | ggplot               |
