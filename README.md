...
| 08 | [Shiny Packaging & Deployment](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture08_Shiny_Packaging_Deployment.html) | Embed a Shiny app inside an R package (`run_app()`); app documentation; deploy to Posit Connect |
