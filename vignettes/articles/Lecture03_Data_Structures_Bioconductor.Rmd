...
|----------------|----------|-------|--------|
| Constructor (1 pt) | `make_se()` | counts matrix + metadata | SummarizedExperiment |
...
The six functions above form the **analysis core**. For HW1, you will expose
