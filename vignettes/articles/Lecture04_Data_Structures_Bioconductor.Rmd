...
Generally, you can interact with `SummarizedExperiment` object as you would with a typical matrix or data.frame, but it also has specialized accessors for its components. The dimensions of the assay matrix are:
