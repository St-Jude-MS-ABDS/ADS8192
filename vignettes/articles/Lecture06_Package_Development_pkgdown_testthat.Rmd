...
4. Explain why tests are essential for maintainability and safe refactoring
...
Currently, `make_se()` doesn't check if the counts matrix has numeric values. Let's fix that.
