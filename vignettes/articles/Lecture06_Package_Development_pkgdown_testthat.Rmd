...
There are a whole host of pre-built general and language-specific actions/workflows that you can find in the [usethis documentation](https://usethis.r-lib.org/reference/use_github_action.html) and the [GitHub Actions Marketplace](https://github.com/marketplace?type=actions).
