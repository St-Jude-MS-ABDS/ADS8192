...
The `airway` package contains an RNA-seq experiment on human airway smooth
muscle cell lines treated with dexamethasone (a glucocorticoid). 8 samples,
4 treated and 4 untreated, with ~64,000 genes.
