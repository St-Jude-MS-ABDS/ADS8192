...
**Rationale:** Before formal analysis, you must check whether samples group by
...
hierarchical clustering is a common diagnostic.
...
**Rationale:** The central question in most gene expression experiments: which
genes change between conditions? [DESeq2](https://bioconductor.org/packages/devel/bioc/vignettes/DESeq2/inst/doc/DESeq2.html) is a common package for
differential expression analysis of count data — it models the mean-variance
relationship with a negative binomial distribution, shares information across
genes to stabilize fold-change estimates, and provides log2 fold-change
shrinkage for reliable ranking. Volcano and MA plots of differential expression
results are bog-standard visualizations for RNA-seq data.

### Dataset: Tissue-Resident Regulatory T Cells (Mouse bulk RNA-seq)

The `tissueTreg` Bioconductor companion package provides htseq count data from
...
- Visualize the network as a correlation heatmap with gene clustering, or as
  a force-directed layout colored by module
