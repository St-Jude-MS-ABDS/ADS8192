...
Running `Rapp exec/sePCA pca --help` works during development, but after a
...
4. Exported a launcher installer (`install_sePCA_cli()`) for seamless terminal use
...
`sePCA pca --help` directly from the terminal after installing your package.
...
- Fallback instructions (`Rapp exec/sePCA pca --help`) for users who skip the launcher
