...
- Who needs it: pipeline users, HPC workflows, collaborators, or only interactive analysts?
- What explicit inputs and outputs must remain stable over time?
- Does the CLI call the same package functions as the R API and Shiny app?
...
- Are you adding a CLI because users need automation, or because it seems impressive?

## Scientific Use Case

A bioinformatics core wants to run your analysis across 40 cohorts in a nightly workflow. They do not want a web app and they do not want to source R files by hand. What contract does a good CLI need to offer so that automation users can trust it?
