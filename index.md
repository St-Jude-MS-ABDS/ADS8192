...
HW1 is the capstone deliverable for Unit 1 and will be what students
work on during labs.
...
analysis functions with R API, Shiny, and CLI presentation layers — for
a basic R package providing PCA tooling.
