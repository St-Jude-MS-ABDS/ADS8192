...
|-----|-----------------------------------------------------------------------------------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| 04  | [Data Structures & R Ecosystems](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture04_Data_Structures_Bioconductor.html)                                | Build an S4 class from scratch; differences in CRAN/Bioconductor; guts of a `SummarizedExperiment`; translating raw code to composable functions                  |
| 05  | [R Package Development (devtools)](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture05_Package_Development_devtools.html)                              | Turn functions into a valid R package; `DESCRIPTION`, `NAMESPACE`, `roxygen2` exports/imports, `devtools::check()`                                                |
| 06  | [R Package Documentation & Testing (pkgdown, testthat)](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture06_Package_Development_pkgdown_testthat.html) | Write `testthat` tests (happy path + error cases); build and deploy a `pkgdown` documentation site; CI/CD with GitHub Actions                                     |
| 07  | [Shiny Reactivity & App Design](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture07_Shiny_Reactivity.html)                                             | Understand the reactive graph; build a UI with `bslib`; connect inputs → reactive expressions → outputs; input validation                                         |
| 08  | [Shiny Packaging & Deployment](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture08_Shiny_Packaging_Deployment.html)                                    | Embed a Shiny app inside an R package ([`run_app()`](https://st-jude-ms-abds.github.io/ADS8192/reference/run_app.md)); app documentation; deploy to Posit Connect |
| 09  | [CLI Design & Development (Rapp)](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture09_CLI_Design_Rapp.html)                                            | Design a CLI with `Rapp`; argument types, defaults, help text; call package functions from `exec/` scripts; pipeline integration                                  |
| 10  | [GitHub Collaboration](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture10_GitHub_Collaboration.html)                                                  | Issues, pull requests, and code review; branch-based workflows; when lightweight vs. heavier process is appropriate                                               |
| 11  | [Unit 1 Review](https://st-jude-ms-abds.github.io/ADS8192/articles/Lecture11_Review_QA.html)                                                                    | Synthesis of all lectures; systematic debugging; end-to-end validation of all deliverables before submission                                                      |
